        ...
        <div className="container">
          <div className="row profile-card">
            <div className="col-sm-3">
              <div className="profile-image position-relative rounded-circle overflow-hidden p-1 ">
                <img
            ...
            <div className="col-sm-9 mt-4 ">
              <div className="profile-info">
                ...
                <p dangerouslySetInnerHTML={{ __html: author?.description }}></p>
                <hr
                  style={{ color: "#B0B0B0", height: "1px", width: "100%" }}
                />
              ...
              <div className="col-lg-3" key={index}>
                <div className="d-flex justify-content-center align-items-center bg-light rounded-5">
                  <div className="coupon-card">
                    ...
                    <div className="d-flex align-items-center justify-content-between py-1">
                      ...
                      <div className="d-flex flex-column w-100 align-items-end">
                        <img
                          ...
                          src={author?.coupons[index]?.media?.thumb}
                        />
                    ...
                    <p className="four-thirteen" dangerouslySetInnerHTML={{ __html: author?.coupons[index]?.content }}>
                    </p>
...
{console.log(author)}  
            {author?.posts && author?.posts.length > 0 && author?.posts.map((post, index) => (
                          ...
                          <div className="published-card">
                            <img src={post?.media?.thumb} alt={post?.title}
