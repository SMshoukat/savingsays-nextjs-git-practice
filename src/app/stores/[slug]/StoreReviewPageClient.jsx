                                    ...
                                    <div className="reviews-first-sec rounded-5 p-4">
                                        <div className="row align-items-center mt-1 justify-content-between">
                                            <div className='col-lg-7'>
                                                <h3 className="seven-twentyseven">Groome Transportation Reviews</h3>
                                            </div>
                                            ...
                                            <div className="col-lg-5 reviews-stars d-flex justify-content-end">
                                                ...
                                                <div className="d-flex border thirtytwo bg-white rating-yellow rounded-4 px-3 py-2">
                                        ...
                                        <div className="mt-4 pe-5 me-2">
                                            <p className="four-eighteen">There are currently no reviews for this A & K Design Company.
                                        ...
                                        {store?.reviews && store?.reviews.map((review) => (
                                            <div className="review feedback-card rounded-5 p-4 mt-4">
                                                ...
                                                <div className="d-flex mt-1">
                                                    <img src="/assets/reviews/Testimonial Person.svg" alt="" />
                                                    <div className="ms-2">
